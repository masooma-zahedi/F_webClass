...
//       setFeedback({ type: "danger", message: "لطفاً همهٔ فیلدها را پر کنید." });
//       return;
//     }
//     setFeedback({
//       type: "success",
//       message:
//         "پیام شما ثبت شد. لطفاً برای پیگیری، ایمیل بفرستید به your@email.com یا در واتس‌اپ پیام دهید.",
//     });
...
//           background:
//             "linear-gradient(135deg, rgba(58,86,210,0.12), rgba(36,113,190,0.06))",
//         }}
//       >
//         {/* سمت راست (عکس و معرفی کوتاه) */}
//         <div
//           className="text-white d-flex flex-column align-items-center p-4"
//           style={{
//             background:
//               "linear-gradient(180deg, rgba(58,86,210,0.95), rgba(36,113,190,0.95))",
//           }}
//         >
//           <div
//             className="rounded-circle overflow-hidden shadow mb-3"
//             style={{
//               width: "160px",
//               height: "160px",
...
//               onError={(e) => {
//                 e.target.src =
//                   "https://via.placeholder.com/160x160.png?text=%D9%85";
//               }}
//             /> */}
//           </div>
//           <h2 className="fw-bold mb-1">معصومه زاهدی</h2>
//           <p className="mb-2">معلم زبان فارسی — کودکان و نوجوانان دوزبانه</p>
...
//             <i className="bi bi-star-fill me-1"></i> با عشق به آموزش زبان
//           </div>
//         </div>

//         {/* سمت چپ (متن بایوگرافی) */}
//         <div
...
//         >
//           <div>
//             <h3 className="text-primary fw-bold mb-3">معرفی کوتاه</h3>
//             <p style={{ lineHeight: "1.7" }}>
//               سلام! من معصومه هستم — معلم زبان فارسی با تجربه در آموزش آنلاین
//               به کودکان و نوجوانان دوزبانه. در کلاس‌های من یادگیری همراه با
//               بازی، داستان و فعالیت‌های خلاقانه است تا زبان فارسی برای شاگردانم
//               شیرین و پرانرژی باشد.
//             </p>

//             <ul className="list-unstyled text-secondary">
//               <li>
//                 <i className="bi bi-mortarboard text-primary me-1"></i> تجربهٔ
//                 چندسالهٔ تدریس
//               </li>
//               <li>
//                 <i className="bi bi-people text-primary me-1"></i> کلاس‌های
//                 دوزبانه و تعاملی
//               </li>
//               <li>
//                 <i className="bi bi-globe text-primary me-1"></i> آموزش آنلاین از
//                 طریق Zoom
//               </li>
//             </ul>
...
//             >
//               <i className="bi bi-envelope-fill me-2"></i> تماس بگیرید
//             </button>
//           </div>

//           <footer className="mt-4 d-flex justify-content-between text-secondary small">
//             <div>کلاس‌های آنلاین از طریق Zoom</div>
//             <div>جلسهٔ آزمایشی رایگان</div>
//           </footer>
//         </div>
//       </div>
...
//               <h5 className="modal-title">تماس با معصومه</h5>
//               <button
//                 type="button"
//                 className="btn-close"
...
//               <p>
//                 خوشحال می‌شوم از شما بشنوم! برای تعیین جلسهٔ آزمایشی یا پرسش
//                 دربارهٔ کلاس‌ها لطفاً اطلاعات زیر را بنویسید:
//               </p>
//               <div className="mb-3">
...
//               </div>
//               <div className="mb-3">
//                 <label className="form-label">ایمیل یا شماره تماس</label>
//                 <input
//                   id="contact"
//                   type="text"
//                   className="form-control"
...
// BiographySlide.jsx (Bootstrap version)
// Single-file React component using Bootstrap 5 and small custom CSS
