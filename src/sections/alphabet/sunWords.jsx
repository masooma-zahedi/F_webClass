...
export default function SunWords({idPage}) {
  ...
  boxes: ["مار","مات","موز","مَغز","مَرد","موم","ماست","مِداد","موتور","آمار","رام","مُپ","موج","مُژده","ماتَم"]
    ...
    صداـل: {
  circle: "حرف ل",
    boxes: ["لاک","بالا","لیز","کالا","سالو","لولا","لوک","پِلاک","پولاد","کِلاس","لِباس","بُلور","لوکس","زُلال","جَلال","بالارو","دِلاوَر","لاک پُشت","سالاد",],
},
  صداـق:{
    circle: "حرف ق",
    boxes: ["قاب","رَقیق","حُقوق","نُقرِه","صادِق","قارچ","ناطِق","یَقین","نَقاش","قُدرَت","عاشِق","سَقف","قاشُق","حَقیر","قَشَنگ","قَلب","مَقصَد","قِرمِز","قانون","قامَت",],
  },
