...
export default function CupGame() {
  ...
  const categories = {
    ...
    "قارچ و مورچه‌ها": ["قارچ","مورچه","کوچولو","قشنگ","بماند","بچینم","دَویدَند","خندیدند","خانَه"],
    "حرف م":["مار","مات","موز","مَغز","مَرد","موم","ماست","مِداد","موتور","آمار","رام","مُپ","موج","مُژده","ماتَم"],
    "برادر کوچک من": ["بیدار","اتاق","دُرُشت","نِگاه","کوچولو","گِرِفتَمش","مِهربانی","قِصّه","آواز","مُراقِب","دوست","صِدا","بَـرادَر","خوابید"]
  ...
  const shuffleCups = () => {
    ...
    const interval = setInterval(() => {
      ...
      count++;
      // شماره برای سختی و آسانی بازی (تعداد حرکت در هر بار بازی ) هست
      if (count > 8) {
